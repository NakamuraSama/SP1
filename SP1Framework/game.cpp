...
int playerhealth = 10; // Player health, default 10. Change accordingly
...
void trap()
{
	for(int i = 1; i < 23; i++)
	{
		...
		if(charLocation.Y == i)
		{
			...
			if(line2[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line3[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line4[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line5[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line6[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line7[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line8[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line9[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line10[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line11[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line12[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line13[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line14[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line15[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line16[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line17[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line18[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line19[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}


			if(line20[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line21[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line22[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}

			if(line23[charLocation.X] == 'x')
			{
				g_quitGame = true;
			}
		}//if end
